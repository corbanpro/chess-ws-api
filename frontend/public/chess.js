...
export class Game {
    ...
    * @returns {Game}
    */
    static init(rule_set) {
        const ptr0 = passStringToWasm0(rule_set, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_init(ptr0, len0);
    ...
    */
    dump() {
        ...
        try {
            ...
            wasm.game_dump(retptr, this.__wbg_ptr);
    ...
    */
    from_dump(dump) {
        const ptr0 = passStringToWasm0(dump, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.game_from_dump(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @returns {boolean}
    */
    is_white_turn() {
        const ret = wasm.game_is_white_turn(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * @returns {boolean}
    */
    is_black_turn() {
        const ret = wasm.game_is_black_turn(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * @returns {number}
    */
    move_num() {
        const ret = wasm.game_move_num(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @returns {any}
    */
    js_board() {
        const ret = wasm.game_js_board(this.__wbg_ptr);
    ...
    */
    get_check_coords() {
        const ret = wasm.game_get_check_coords(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    get_legal_moves(start_sq_str) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.game_get_legal_moves(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    */
    has_last_rank_pawn() {
        const ret = wasm.game_has_last_rank_pawn(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * @param {string} piece_type_str
    */
    replace_last_rank_pawn(piece_type_str) {
        const ptr0 = passStringToWasm0(piece_type_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.game_replace_last_rank_pawn(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @param {string} loser_team_str
    * @returns {boolean}
    ...
    * @returns {any}
    */
    move_piece(start_sq_str, target_sq_str) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(start_sq_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            ...
            wasm.game_move_piece(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
